...
if ( ! isset( $content_width ) )
  ...
  function bnb_theme_features()  {
    ...
    register_nav_menus( array(
        'primary'   => __( 'Home Menu', 'bnb' ),
        'page'   => __( 'Page Menu', 'bnb' ),
  	...
  	function bnb_sidebars() {
  		...
  		$footer1 = array(
  			'id'            => 'ecwid-cart',
  			'class'         => 'bnb-ecwid-cart',
				'before_widget' => '',
				'after_widget' 	=> '',
  			'name'          => __( 'Ecwid Cart', 'bnb' ),
  		);
  		register_sidebar( $footer1 );
  	}
  ...
  function bnb_enqueue_scripts() {
    ...
    wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css?family=Poppins:400,600,700|Montserrat:400,600,700&display=swap' );
